...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // ১. সাইট লোড হওয়ার ৫ সেকেন্ড পর পপ-আপ দেখাবে (যদি আগে না দেখিয়ে থাকে)
    ...
    // ২. ক্লোজ বাটনে ক্লিক করলে বন্ধ হবে এবং ব্রাউজারে সেভ রাখবে
    if (closeBtn) {
        closeBtn.addEventListener("click", () => {
            popup.classList.remove("show");
            localStorage.setItem("popupShown", "true"); // যাতে বারবার না আসে
        });
    }

    // ৩. পপ-আপের বাইরে ক্লিক করলে বন্ধ হবে
    ...
    // ৪. ইমেইল সাবমিট করলে কুপন কোড দেখাবে
    if (form) {
        form.addEventListener("submit", (e) => {
            e.preventDefault(); // পেজ রিলোড বন্ধ করবে
            
            // ফর্ম লুকিয়ে কুপন দেখাবে
            form.style.display = "none";
            result.style.display = "block";
            
            // "popupShown" সেভ করবে যাতে ভবিষ্যতে আর পপ-আপ না আসে
            localStorage.setItem("popupShown", "true");
        });
    }
});